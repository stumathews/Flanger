...
typedef unsigned (DLL_CALLCONV *FI_ReadProc) (void *m_Buffer, unsigned size, unsigned count, fi_handle handle);
typedef unsigned (DLL_CALLCONV *FI_WriteProc) (void *m_Buffer, unsigned size, unsigned count, fi_handle handle);
...
DLL_API unsigned DLL_CALLCONV FreeImage_ReadMemory(void *m_Buffer, unsigned size, unsigned count, FIMEMORY *stream);
DLL_API unsigned DLL_CALLCONV FreeImage_WriteMemory(const void *m_Buffer, unsigned size, unsigned count, FIMEMORY *stream);
