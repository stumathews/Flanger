...
*/
typedef FMOD_RESULT (F_CALLBACK *FMOD_OUTPUT_READFROMMIXER)             (FMOD_OUTPUT_STATE *output_state, void *m_Buffer, unsigned int length);
typedef FMOD_RESULT (F_CALLBACK *FMOD_OUTPUT_COPYPORT)                  (FMOD_OUTPUT_STATE *output, int portId, void *m_Buffer, unsigned int length);
...
{
    float          *m_Buffer;         /* [r] Mono PCM floating point buffer. This buffer needs to be scaled by the gain value to get distance attenuation.  */
