...
struct FMOD_ASYNCREADINFO
{
    ...
    void                 *m_Buffer;    /* [w] Buffer to read file data into. */
...
typedef FMOD_RESULT (F_CALLBACK *FMOD_FILE_READ_CALLBACK)       (void *handle, void *m_Buffer, unsigned int sizebytes, unsigned int *bytesread, void *userdata);
